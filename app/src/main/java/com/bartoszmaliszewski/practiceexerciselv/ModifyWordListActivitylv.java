...
public class ModifyWordListActivitylv extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modify_word_list_activitylv);
    ...
    public void returnHome() {
        ...
        Intent home_intent = new Intent(getApplicationContext(), PracticeExerciselvActivity.class)
